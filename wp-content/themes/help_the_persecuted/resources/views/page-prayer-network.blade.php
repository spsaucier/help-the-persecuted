      ...
      <div class="columns has-text-centered">
        ...
        <div class="column is-one-half prayernetwork-join">
          <div class="inner">
            ...
            <div class="mc-field-group js-sr-set-1">
            ...
            <div class="mc-field-group js-sr-set-1">
                ...
                <div class="clear"><input type="submit" value="Submit" name="subscribe" id="mc-embedded-subscribe" class="button js-sr-set-1"></div>
                </div>
            </form>
            </div>
